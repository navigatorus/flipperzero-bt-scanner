...
void bt_test_app_draw_callback(Canvas* canvas, void* context) {
    ...
    canvas_draw_str(canvas, 2, 12, "BT Device Scanner"); // Сдвинули на 12
    canvas_draw_line(canvas, 0, 14, 127, 14); // Сдвинули линию
    
    canvas_set_font(canvas, FontSecondary);
    canvas_draw_str(canvas, 2, 27, app->status); // Сдвинули статус
    
    if(app->scanning) {
        canvas_draw_str(canvas, 2, 42, "Scanning..."); // Сдвинули
        canvas_draw_str(canvas, 2, 52, "Check nearby devices"); // Сдвинули
    } else if(app->device_found) {
        canvas_draw_str(canvas, 2, 42, "BT devices detected!"); // Сдвинули
        canvas_draw_str(canvas, 2, 52, "Try full scanner app"); // Сдвинули
    } else {
        canvas_draw_str(canvas, 2, 42, "No devices found"); // Сдвинули
        canvas_draw_str(canvas, 2, 52, "Ensure BT is enabled"); // Сдвинули
    }
    
    canvas_draw_line(canvas, 0, 57, 127, 57); // Сдвинули линию
    canvas_draw_str(canvas, 2, 67, "OK=Scan  Back=Exit"); // Сдвинули подсказки
